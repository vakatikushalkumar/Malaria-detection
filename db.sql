...
--
ALTER TABLE `disease`
  DROP FOREIGN KEY `disease_ibfk_1`,
  ADD CONSTRAINT `disease_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`p_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

--
-- Constraints for table `lab_reports`
--
ALTER TABLE `lab_reports`
  DROP FOREIGN KEY `lab_reports_ibfk_1`,
  DROP FOREIGN KEY `lab_reports_ibfk_2`,
  ADD CONSTRAINT `lab_reports_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`p_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `lab_reports_ibfk_2` FOREIGN KEY (`test_id`) REFERENCES `lab_tests` (`Id`) ON DELETE RESTRICT ON UPDATE CASCADE;

--
-- Constraints for table `lab_requests`
--
ALTER TABLE `lab_requests`
  DROP FOREIGN KEY `lab_requests_ibfk_1`,
  DROP FOREIGN KEY `lab_requests_ibfk_2`,
  ADD CONSTRAINT `lab_requests_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`p_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `lab_requests_ibfk_2` FOREIGN KEY (`test_id`) REFERENCES `tests_under` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`user_type`) REFERENCES `user_types` (`type_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
